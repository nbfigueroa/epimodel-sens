...
###############################################
####  SEIR Model Simulation with One Closure  ##
###############################################
# epidemic parameters
...
plt.savefig('../../MIT-COVID19-Model-Evaluation/snaps/cambridgeSEIRModelwSC_oneClusure.png', format='png', dpi=200)
...
plt.savefig('../../MIT-COVID19-Model-Evaluation/snaps/cambridgeSEIRModelwSC_twoClusures.png', format='png', dpi=200)
m1 = .01*MM*(data['X'][0,0:M]-data['X'][-1,0:M])
np.sum(m1)
SC[-1]-SC[0]
...
plt.autoscale(enable=True, axis='x', tight=True)
plt.ylabel('Infected individuals'); plt.xlim(0, 98); plt.ylim(0, maxY);
plt.savefig('../../MIT-COVID19-Model-Evaluation/snaps/cambridgeSEIRModelwSC_threeClusures.png', format='png', dpi=200)
plt.show()
...
t1=int(Nf/(14))
plt.fill_between(t[3*t1:16*t1], 0, maxY, color="#A60628", alpha=0.2)
...
plt.autoscale(enable=True, axis='x', tight=True)
plt.ylabel('Infected individuals'); plt.xlim(0, 98); plt.ylim(0, maxY);
plt.savefig('../../MIT-COVID19-Model-Evaluation/snaps/cambridgeSEIRModelwSC_longClusure.png', format='png', dpi=200)
