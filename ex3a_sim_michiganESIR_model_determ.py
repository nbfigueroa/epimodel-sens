...
if __name__ == '__main__':
    ...
    #############################################################
    ######## Simulation Determinstic ESIR Model Dynamics ########
    #############################################################
    ...
    figure_title   = figure_title.format(scenario=scenario, R0=float(r0), beta= beta, gamma = 1/gamma_inv)
    plotSIR_evolution(figure_title, SIRvariables, N, Plotoptions, file_extension, number_scaling,  x_tick_labels)
    ...
    plotInfected_evolution(figure_title, Ivariables, N, Plotoptions, file_extension, number_scaling,  x_tick_labels, Infected_conf, Infected_est, check_points)
