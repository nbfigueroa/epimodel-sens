...
def plotSIR_evolution(txt_title, SIRparams, SIRvariables, Plotoptions, store_plots, filename):
    ...
    if plot_all:        
        ...
        ax1.text(t[-1] - x_axis_offset, (total_cases/N) - y_axis_offset, txt1.format(per=total_cases/1000000), fontsize=20, color='r')    
...
def plotSIR_evolutionErrors(txt_title, SIRparams, S_variables, I_variables, R_variables, Plotoptions, store_plots, filename):
    ...
    ax1.text(t[-1]-x_axis_offset, (total_cases/N) - 0.05, txt1.format(per=total_cases/1000000), fontsize=20, color='r')
