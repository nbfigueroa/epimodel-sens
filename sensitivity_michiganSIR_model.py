...
###################################################
######## Load simulations from pickle file ########
###################################################
# Load the dictionary back from the pickle file.
import pickle

data = pickle.load( open( "./data/michigan_runs.pkl", "rb" ) )
S_MC = data['S']
I_MC = data['I']
R_MC = data['R']
...
txt_title = r"COVID-19 Cambridge SIR Model Dynamics (N={N:10.0f})"
fig.suptitle(txt_title.format(N=N),fontsize=20)
for i in range(100):
    ax1.plot(t, I_MC[i,:]/N, 'r', lw=2,   label='Infected')
