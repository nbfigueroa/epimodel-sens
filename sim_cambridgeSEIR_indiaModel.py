...
# plt.savefig('../../MIT-COVID19-Model-Evaluation/snaps/cambridgeSEIRModel_forecast_betaEstimate.png', format='png', dpi=212)
...
# r0 = beta*gamma_inv
txt_title = r"COVID-19 Cambridge SEIR Model Dynamics (N={N:10.0f},$R_0$={R0:1.3f}, $\beta$={beta:1.3f}, 1/$\gamma$={gamma_inv:1.3f}"
...
#plt.plot(t*0+t[np.argsort(IC)[-1]], -55+.3*SC*10**(-6), lw=4, color='g', alpha=0.8)
plt.xticks(np.arange(0, 200, 30), ('4 Mar', '3 Apr', '3 May', '2 Jun', '2 Jul', '1 Aug', '31 Aug'));
plt.savefig('../../MIT-COVID19-Model-Evaluation/snaps/cambridgeSEIRModel_timeEvolution.png', format='png', dpi=212)
...
plt.xticks(np.arange(0, 200, 30), ('4 Mar', '3 Apr', '3 May', '2 Jun', '2 Jul', '1 Aug', '31 Aug'));
plt.savefig('../../MIT-COVID19-Model-Evaluation/snaps/cambridgeSEIRModel_reproductiveRate.png', format='png', dpi=212)
