...
plt.savefig('../../MIT-COVID19-Model-Evaluation/snaps/cambridgeModel_forecast_betaEstimate.png', format='png', dpi=212)
...
plt.savefig('../../MIT-COVID19-Model-Evaluation/snaps/cambridgeModel_forecast_timeEvolution.png', format='png', dpi=212)
...
plt.xticks(np.arange(0, 200, 30), ('4 Mar', '3 Apr', '3 May', '2 Jun', '2 Jul', '1 Aug', '31 Aug'));
plt.savefig('../../MIT-COVID19-Model-Evaluation/snaps/cambridgeModel_forecast_reproductiveRate.png', format='png', dpi=212)
