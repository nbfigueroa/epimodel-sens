...
# Initial values from March 21st
if sim_num == 1:
    N            = 1486947036
    days         = 356
    gamma_inv    = 7  
...
def deriv(y, t, N, beta, gamma, kappa, m):
    S, E, I, R, D = y
    
    # Main state variables with exponential rates
    dSdt = -beta * (I/N) * S 
    dEdt = beta * (S/N) * I  - kappa * E
...
ode_sol = odeint(deriv, y0, t, args=(N, beta, gamma, kappa, m))
S, E, I, R, D = ode_sol.T
...
ax1.plot(t, D/N, 'b',  lw=2,  label='Dead')
